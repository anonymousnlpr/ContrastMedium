...
stri =stri+'<tr><td>N_R</td><td>0.9628609010707061</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.010857675648503961</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.008531610325290614</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.008531610325290514</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.005428837824251981</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.0012631216019855943</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.0012631216019855943</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.0012631216019855943</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#0a28e1', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#0a28e1', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#0628ed', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0128fc', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#0d28d8', bc: '#0000FF', bw: '0' } }

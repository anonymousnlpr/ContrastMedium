...
stri =stri+'<tr><td>N_l1_1</td><td>0.34744562075212676</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.16167956505415607</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.13650576520464822</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.13650576520464822</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.05977654725150775</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.05434231568318886</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.05434231568318886</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.04940210516653533</td></tr>';
...
,{ data: { id: 'N_R',color:'#4c281b', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_1',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#452830', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#452830', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#3e2845', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#ce2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#ae2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#ae2800', bc: '#0000FF', bw: '0' } }

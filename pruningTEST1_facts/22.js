...
stri =stri+'<tr><td>N_l1_1</td><td>0.21749827772857003</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.1309910441885641</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.1190827674441492</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.1190827674441492</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.1082570613128629</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.1082570613128629</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.09841551028442082</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.09841551028442082</td></tr>';
...
,{ data: { id: 'N_R',color:'#a72800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_1',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#972800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#972800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#8a2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#8a2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#7d2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#7d2800', bc: '#0000FF', bw: '0' } }

...
stri =stri+'<tr><td>N_l1_1</td><td>0.3197770385919286</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.15933670383938728</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.14485154894489755</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.14485154894489755</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.06343120707742764</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.05766473370675239</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.05766473370675239</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.05242248518795672</td></tr>';
...
,{ data: { id: 'N_R',color:'#50280f', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_1',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#492824', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#492824', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#422839', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#cb2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#b82800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#b82800', bc: '#0000FF', bw: '0' } }

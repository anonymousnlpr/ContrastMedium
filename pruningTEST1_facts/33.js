...
stri =stri+'<tr><td>N_R</td><td>0.7920547309419511</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.06825288260232411</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.034126441301162054</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.021715351297007923</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.021715351297007923</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.021715351297007923</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.0202099456317696</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.020209945631769508</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#1928b4', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#1928b4', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#2b287e', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#1b28ae', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#572800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#1b28ae', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#1b28ae', bc: '#0000FF', bw: '0' } }

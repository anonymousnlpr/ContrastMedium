...
stri =stri+'<tr><td>N_l1_1</td><td>0.3185869610547363</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.17332452541649987</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.1283051443373389</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.1283051443373389</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.06899969434771978</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.06272699486156344</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.06272699486156344</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.057024540783239486</td></tr>';
...
,{ data: { id: 'N_R',color:'#572800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_1',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#4f2812', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#4f2812', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#482827', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#dc2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#a32800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#a32800', bc: '#0000FF', bw: '0' } }

...
stri =stri+'<tr><td>N_l1_1</td><td>0.3405081007480709</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.15084683615695435</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.11993163802022676</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.11993163802022676</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.07374738374965323</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.06704307613604839</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.06704307613604839</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.06094825103277126</td></tr>';
...
,{ data: { id: 'N_R',color:'#5e2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_1',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#552800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#552800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#4d2818', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#c02800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#982800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#982800', bc: '#0000FF', bw: '0' } }

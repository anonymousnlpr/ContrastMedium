...
stri =stri+'<tr><td>N_R</td><td>0.8514436042828251</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.043430702594015845</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.03412644130116215</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.034126441301162054</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.021715351297007923</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.005052486407942377</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.005052486407942377</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.005052486407942377</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#2b287e', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#2b287e', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#1b28ae', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0628ed', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#37285a', bc: '#0000FF', bw: '0' } }

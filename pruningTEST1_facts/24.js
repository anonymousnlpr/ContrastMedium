...
stri =stri+'<tr><td>N_l1_1</td><td>0.2859580130256659</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.16902505806752907</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.1003237935770478</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.1003237935770478</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.09448682619518789</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.08589711472289807</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.08589711472289807</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.07808828611172552</td></tr>';
...
,{ data: { id: 'N_R',color:'#782800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_1',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#6d2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#6d2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#632800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#d72800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#7f2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#7f2800', bc: '#0000FF', bw: '0' } }

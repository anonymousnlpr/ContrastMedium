...
stri =stri+'<tr><td>N_l2_1</td><td>0.27301153040929643</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.2553225838059172</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.08686140518803169</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.08686140518803169</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.08686140518803169</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.08083978252707809</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.08083978252707803</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.04940210516653533</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#672800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#672800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#3e2845', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#6e2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#6e2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#6e2800', bc: '#0000FF', bw: '0' } }

...
stri =stri+'<tr><td>N_R</td><td>0.9158170072062856</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.021715351297008016</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.021715351297007923</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.010104972815884754</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.008531610325290514</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.008531610325290514</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.008531610325290514</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.005052486407942377</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#1b28ae', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#1b28ae', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#0628ed', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0a28e1', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#0c28db', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#0a28e1', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#0a28e1', bc: '#0000FF', bw: '0' } }

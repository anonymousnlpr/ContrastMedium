...
stri =stri+'<tr><td>N_l1_1</td><td>0.32397218708644376</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.1250265041565829</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.10704754662903687</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.09731595148094262</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.09731595148094262</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.08846904680085692</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.0804264061825972</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.0804264061825972</td></tr>';
...
,{ data: { id: 'N_R',color:'#882800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_1',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#7c2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#7c2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#702800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#9f2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#662800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#662800', bc: '#0000FF', bw: '0' } }

...
stri =stri+'<tr><td>N_l1_1</td><td>0.2924927529821547</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.1457104969536708</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.13246408813970076</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.13246408813970076</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.08145373566430282</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.07404885060391166</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.07404885060391166</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.06731713691264696</td></tr>';
...
,{ data: { id: 'N_R',color:'#672800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_1',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#5e2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#5e2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#552800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#b92800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#a82800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#a82800', bc: '#0000FF', bw: '0' } }

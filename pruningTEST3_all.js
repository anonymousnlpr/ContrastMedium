...
var graph3 = {
nodes: [
{ data: { id: 'R', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:2 , y:4} }
,{ data: { id: 'l1', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:3 , y:9} }
,{ data: { id: 'g1', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:7 , y:5} }
,{ data: { id: 'l2', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:5 , y:3} }
,{ data: { id: 'g2', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:8 , y:3} }
,{ data: { id: 'l3', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:8 , y:0} }
,{ data: { id: 'g3', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:9 , y:9} }
,{ data: { id: 'l4', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:1 , y:0} }
,{ data: { id: 'g4', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:3 , y:7} }
,{ data: { id: 'l5', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:0 , y:8} }
,{ data: { id: 'g5', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:2 , y:5} }
,{ data: { id: 'l6', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:1 , y:9} }
,{ data: { id: 'g6', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:4 , y:7} }
,{ data: { id: 'l7', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:3 , y:0} }
,{ data: { id: 'g7', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:9 , y:5} }
,{ data: { id: 'l8', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:6 , y:5} }
,{ data: { id: 'g8', parent: 'KB', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:5 , y:3} }
,{ data: { id: 'N_R', parent: 'PCZ', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:5 , y:9} }
,{ data: { id: 'N_l1_1', parent: 'PCZ', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:2 , y:2} }
,{ data: { id: 'N_l1_2', parent: 'PCZ', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:8 , y:0} }
,{ data: { id: 'N_l1_3', parent: 'PCZ', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:4 , y:3} }
,{ data: { id: 'N_g3', parent: 'PCZ', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:0 , y:9} }
,{ data: { id: 'N_l2_1', parent: 'PCZ', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:0 , y:7} }
,{ data: { id: 'N_g1', parent: 'PCZ', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:7 , y:7} }
,{ data: { id: 'N_g2', parent: 'PCZ', bc: '#0000FF', bw: '0', color:'#0000FF'}, position:{ x:0 , y:6} }
...
,{ data: { id: 'g8---N_g2', style: 'dashed', opacity : '1.0', weight:'2', source: 'g8', target: 'N_g2' , color: '#ff6699' } }
...
var filename ='pruningTEST3_facts/1.js';

...
stri =stri+'<tr><td>N_R</td><td>0.46321838290324796</td></tr>';
stri =stri+'<tr><td>N_l6</td><td>0.19297718979032918</td></tr>';
stri =stri+'<tr><td>N_l5</td><td>0.13800798432606892</td></tr>';
stri =stri+'<tr><td>N_l7</td><td>0.09081279519544903</td></tr>';
stri =stri+'<tr><td>N_l8</td><td>0.04273543303315249</td></tr>';
stri =stri+'<tr><td>N_l1</td><td>0.04022158403120244</td></tr>';
stri =stri+'<tr><td>N_l2</td><td>0.01892780424997757</td></tr>';
stri =stri+'<tr><td>N_l3</td><td>0.008907201999989445</td></tr>';
stri =stri+'<tr><td>N_l4</td><td>0.004191624470583268</td></tr>';
...
,{ data: { id: 'N_l1',color:'#332866', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2',color:'#1828b7', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l3',color:'#0b28de', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l4',color:'#0528f0', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g4',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l5',color:'#af2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g5',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l6',color:'#f62800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g6',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l7',color:'#732800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g7',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l8',color:'#36285d', bc: '#0000FF', bw: '0' } }

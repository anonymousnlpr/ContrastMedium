...
stri =stri+'<tr><td>N_l1</td><td>0.2773829448180917</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.2610663010052628</td></tr>';
stri =stri+'<tr><td>N_l2</td><td>0.1305331505026314</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.12285472988482954</td></tr>';
stri =stri+'<tr><td>N_l3</td><td>0.06142736494241477</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.05781399053403743</td></tr>';
stri =stri+'<tr><td>N_l4</td><td>0.028906995267018714</td></tr>';
stri =stri+'<tr><td>N_g4</td><td>0.027206583780723496</td></tr>';
stri =stri+'<tr><td>N_l5</td><td>0.013603291890361748</td></tr>';
stri =stri+'<tr><td>N_g5</td><td>0.012803098249752233</td></tr>';
stri =stri+'<tr><td>N_l6</td><td>0.006401549124876117</td></tr>';
...
,{ data: { id: 'N_l2',color:'#a62800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#9c2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l3',color:'#4e2815', bc: '#0000FF', bw: '0' } }

...
stri =stri+'<tr><td>N_R</td><td>0.5683464824421587</td></tr>';
stri =stri+'<tr><td>N_l1</td><td>0.19297718979032927</td></tr>';
stri =stri+'<tr><td>N_l2</td><td>0.09081279519544903</td></tr>';
stri =stri+'<tr><td>N_l8</td><td>0.06900399216303446</td></tr>';
stri =stri+'<tr><td>N_l3</td><td>0.04273543303315249</td></tr>';
stri =stri+'<tr><td>N_l4</td><td>0.02011079201560117</td></tr>';
stri =stri+'<tr><td>N_l5</td><td>0.009463902124988785</td></tr>';
stri =stri+'<tr><td>N_l6</td><td>0.004453600999994723</td></tr>';
stri =stri+'<tr><td>N_l7</td><td>0.002095812235291634</td></tr>';
...
,{ data: { id: 'N_l1',color:'#f62800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2',color:'#732800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l3',color:'#36285d', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l4',color:'#1928b4', bc: '#0000FF', bw: '0' } }
...
,{ data: { id: 'N_l8',color:'#572800', bc: '#0000FF', bw: '0' } }

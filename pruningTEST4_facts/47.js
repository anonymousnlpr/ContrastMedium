...
stri =stri+'<tr><td>N_R</td><td>0.7316091914516241</td></tr>';
stri =stri+'<tr><td>N_l6</td><td>0.09648859489516459</td></tr>';
stri =stri+'<tr><td>N_l5</td><td>0.06900399216303446</td></tr>';
stri =stri+'<tr><td>N_l7</td><td>0.04540639759772452</td></tr>';
stri =stri+'<tr><td>N_l8</td><td>0.021367716516576245</td></tr>';
stri =stri+'<tr><td>N_l1</td><td>0.020110792015601304</td></tr>';
stri =stri+'<tr><td>N_l2</td><td>0.009463902124988785</td></tr>';
stri =stri+'<tr><td>N_l3</td><td>0.004453600999994723</td></tr>';
stri =stri+'<tr><td>N_l4</td><td>0.002095812235291634</td></tr>';
...
,{ data: { id: 'N_l1',color:'#1928b4', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2',color:'#0c28db', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l3',color:'#0528f0', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l4',color:'#0228f9', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g4',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l5',color:'#572800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g5',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l6',color:'#7b2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g6',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l7',color:'#392854', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g7',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l8',color:'#1b28ae', bc: '#0000FF', bw: '0' } }

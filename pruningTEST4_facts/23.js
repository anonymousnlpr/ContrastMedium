...
stri =stri+'<tr><td>N_l1</td><td>0.2828142935991684</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.26617815868157024</td></tr>';
stri =stri+'<tr><td>N_l2</td><td>0.13308907934078512</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.12526030996779774</td></tr>';
stri =stri+'<tr><td>N_l3</td><td>0.06263015498389887</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.05894602822014011</td></tr>';
stri =stri+'<tr><td>N_l4</td><td>0.029473014110070056</td></tr>';
stri =stri+'<tr><td>N_g4</td><td>0.027739307397712992</td></tr>';
stri =stri+'<tr><td>N_l5</td><td>0.013869653698856496</td></tr>';
...
,{ data: { id: 'N_l2',color:'#a92800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#9f2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l3',color:'#4f2812', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#4b281e', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l4',color:'#252890', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g4',color:'#232896', bc: '#0000FF', bw: '0' } }

...
stri =stri+'<tr><td>N_l1</td><td>0.32508436445444316</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.3059617547806524</td></tr>';
stri =stri+'<tr><td>N_l2</td><td>0.1529808773903262</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.14398200224971874</td></tr>';
stri =stri+'<tr><td>N_l3</td><td>0.07199100112485937</td></tr>';
...
,{ data: { id: 'N_l2',color:'#c32800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#b72800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l3',color:'#5b2800', bc: '#0000FF', bw: '0' } }

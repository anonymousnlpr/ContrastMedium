...
stri =stri+'<tr><td>N_l1</td><td>0.27339423834723914</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.25731222432681333</td></tr>';
stri =stri+'<tr><td>N_l2</td><td>0.12865611216340667</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.12108810556555921</td></tr>';
stri =stri+'<tr><td>N_l3</td><td>0.060544052782779606</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.056982637913204334</td></tr>';
stri =stri+'<tr><td>N_l4</td><td>0.028491318956602167</td></tr>';
stri =stri+'<tr><td>N_g4</td><td>0.026815359017978508</td></tr>';
stri =stri+'<tr><td>N_l5</td><td>0.013407679508989254</td></tr>';
stri =stri+'<tr><td>N_g5</td><td>0.01261899247904871</td></tr>';
stri =stri+'<tr><td>N_l6</td><td>0.006309496239524355</td></tr>';
stri =stri+'<tr><td>N_g6</td><td>0.005924101496748381</td></tr>';
stri =stri+'<tr><td>N_l7</td><td>0.0029620507483741907</td></tr>';
stri =stri+'<tr><td>N_g7</td><td>0.0027878124690580612</td></tr>';
stri =stri+'<tr><td>N_l8</td><td>0.0013939062345290306</td></tr>';
stri =stri+'<tr><td>N_g8</td><td>0.00131191175014497</td></tr>';
...
,{ data: { id: 'N_l2',color:'#a42800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#9a2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l3',color:'#4d2818', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#482827', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l4',color:'#242893', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g4',color:'#222899', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l5',color:'#1128cc', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g5',color:'#1028cf', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l6',color:'#0828e7', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g6',color:'#0728ea', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l7',color:'#0328f6', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g7',color:'#0328f6', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l8',color:'#0128fc', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g8',color:'#0128fc', bc: '#0000FF', bw: '0' } }

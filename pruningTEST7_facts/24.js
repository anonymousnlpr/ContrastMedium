...
stri =stri+'<tr><td>N_R</td><td>0.2983312665796574</td></tr>';
stri =stri+'<tr><td>N_L</td><td>0.2486093888163812</td></tr>';
stri =stri+'<tr><td>N_M</td><td>0.20717449068031768</td></tr>';
stri =stri+'<tr><td>N_N</td><td>0.17264540890026472</td></tr>';
stri =stri+'<tr><td>N_O</td><td>0.07193558704177697</td></tr>';
stri =stri+'<tr><td>N_G</td><td>0.0013038579816021293</td></tr>';
...
,{ data: { id: 'N_M',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_N',color:'#dc2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_O',color:'#5b2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_G',color:'#0128fc', bc: '#0000FF', bw: '0' } }

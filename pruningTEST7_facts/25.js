...
stri =stri+'<tr><td>N_L</td><td>0.27552258040949196</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.26639273674407327</td></tr>';
stri =stri+'<tr><td>N_M</td><td>0.18499495607227312</td></tr>';
stri =stri+'<tr><td>N_N</td><td>0.15416246339356093</td></tr>';
stri =stri+'<tr><td>N_O</td><td>0.06423435974731706</td></tr>';
stri =stri+'<tr><td>N_G</td><td>0.054692903633283614</td></tr>';
...
,{ data: { id: 'N_L',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_M',color:'#eb2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_N',color:'#c42800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_O',color:'#51280c', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_G',color:'#452830', bc: '#0000FF', bw: '0' } }

...
stri =stri+'<tr><td>N_N</td><td>0.3512938674228997</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.1914214817440624</td></tr>';
stri =stri+'<tr><td>N_L</td><td>0.14501627404853212</td></tr>';
stri =stri+'<tr><td>N_M</td><td>0.12084689504044342</td></tr>';
stri =stri+'<tr><td>N_O</td><td>0.10441171731494313</td></tr>';
stri =stri+'<tr><td>N_G</td><td>0.08700976442911927</td></tr>';
...
,{ data: { id: 'N_R',color:'#f42800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_L',color:'#b82800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_M',color:'#9a2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_N',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_O',color:'#852800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_G',color:'#6e2800', bc: '#0000FF', bw: '0' } }

...
stri =stri+'<tr><td>N_G</td><td>0.17564693371144985</td></tr>';
stri =stri+'<tr><td>N_L</td><td>0.10441171731494313</td></tr>';
stri =stri+'<tr><td>N_M</td><td>0.08700976442911927</td></tr>';
stri =stri+'<tr><td>N_N</td><td>0.07250813702426606</td></tr>';
stri =stri+'<tr><td>N_O</td><td>0.06042344752022171</td></tr>';
...
,{ data: { id: 'N_L',color:'#852800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_M',color:'#6e2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_N',color:'#5c2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_O',color:'#4d2818', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_G',color:'#df2800', bc: '#0000FF', bw: '0' } }

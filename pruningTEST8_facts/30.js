...
stri =stri+'<tr><td>N_R</td><td>0.5522058586574715</td></tr>';
stri =stri+'<tr><td>N_O</td><td>0.17564693371144985</td></tr>';
stri =stri+'<tr><td>N_L</td><td>0.08700976442911927</td></tr>';
stri =stri+'<tr><td>N_M</td><td>0.07250813702426606</td></tr>';
stri =stri+'<tr><td>N_N</td><td>0.06042344752022171</td></tr>';
stri =stri+'<tr><td>N_G</td><td>0.052205858657471564</td></tr>';
...
,{ data: { id: 'N_L',color:'#6e2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_M',color:'#5c2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_N',color:'#4d2818', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_O',color:'#df2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_G',color:'#422839', bc: '#0000FF', bw: '0' } }

...
stri =stri+'<tr><td>N_R</td><td>0.6346897376416463</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.10063650895699658</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.10063650895699654</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.03866333119030711</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.03534741588629987</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.03534741588629987</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.03534741588629987</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.019331665595153556</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#802800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#802800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#1828b7', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#2d2878', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#31286c', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#2d2878', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#2d2878', bc: '#0000FF', bw: '0' } }

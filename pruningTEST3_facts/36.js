...
stri =stri+'<tr><td>N_R</td><td>0.9086724344104111</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.025159127239249145</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.025159127239249082</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.009665832797576778</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.008836853971574967</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.008836853971574967</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.008836853971574967</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.004832916398788389</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#20289f', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#20289f', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#0628ed', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0b28de', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#0c28db', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#0b28de', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#0b28de', bc: '#0000FF', bw: '0' } }

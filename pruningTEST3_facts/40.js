...
stri =stri+'<tr><td>N_R</td><td>0.9862385649645644</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.004418426985787483</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.0022092134928937417</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.0015724454524530715</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.0015724454524530715</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.0015724454524530715</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.0012082290996970973</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.001208229099697029</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#0128fc', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#0128fc', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#0228f9', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0228f9', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#0528f0', bc: '#0000FF', bw: '0' } }

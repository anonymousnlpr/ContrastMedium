...
stri =stri+'<tr><td>N_l1_1</td><td>0.4238104761731605</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.2635738327745083</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.10999800003636298</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.10261950916472921</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.09999818185123907</td></tr>';
...
,{ data: { id: 'N_l2_1',color:'#8c2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#7f2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#822800', bc: '#0000FF', bw: '0' } }

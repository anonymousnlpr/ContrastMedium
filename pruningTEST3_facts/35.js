...
stri =stri+'<tr><td>N_R</td><td>0.8393290373132872</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.05031825447849829</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.03534741588629987</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.035347415886299804</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.025159127239249145</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.004832916398788389</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.004832916398788389</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.004832916398788389</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#2d2878', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#2d2878', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#20289f', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0628ed', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#40283f', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#0628ed', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#0628ed', bc: '#0000FF', bw: '0' } }

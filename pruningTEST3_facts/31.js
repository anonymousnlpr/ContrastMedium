...
stri =stri+'<tr><td>N_l2_1</td><td>0.282779327090399</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.16002131232038602</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.1006365089569966</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.1006365089569966</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.1006365089569966</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.1006365089569966</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.07732666238061425</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.07732666238061423</td></tr>';
...
,{ data: { id: 'N_R',color:'#802800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_1',color:'#622800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#622800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#cc2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#802800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#802800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#802800', bc: '#0000FF', bw: '0' } }

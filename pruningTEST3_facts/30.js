...
stri =stri+'<tr><td>N_l1_1</td><td>0.4025460358279864</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.16002131232038602</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.1546533247612285</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.1421853954892822</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.14059393160111683</td></tr>';
...
,{ data: { id: 'N_g3',color:'#cc2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#c52800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#b32800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#b52800', bc: '#0000FF', bw: '0' } }

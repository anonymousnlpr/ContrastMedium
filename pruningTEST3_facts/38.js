...
stri =stri+'<tr><td>N_R</td><td>0.9598322593283213</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.012579563619624572</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.008836853971574967</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.008836853971574899</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.006289781809812286</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.0012082290996970973</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.0012082290996970973</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.0012082290996970973</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#0b28de', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#0b28de', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#0828e7', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0128fc', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#1028cf', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#0128fc', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#0128fc', bc: '#0000FF', bw: '0' } }

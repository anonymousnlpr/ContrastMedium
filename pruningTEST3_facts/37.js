...
stri =stri+'<tr><td>N_R</td><td>0.9449542598582609</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.017673707943149933</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.008836853971574967</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.006289781809812286</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.006289781809812286</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.006289781809812286</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.004832916398788389</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.004832916398788323</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#0628ed', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#0628ed', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#0b28de', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0828e7', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#1628bd', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#0828e7', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#0828e7', bc: '#0000FF', bw: '0' } }

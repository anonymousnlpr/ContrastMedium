...
stri =stri+'<tr><td>N_l1_1</td><td>0.40920717515585125</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>0.19245939934735193</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.14066493217271234</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>0.12979128225798228</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>0.12787721106610214</td></tr>';
...
,{ data: { id: 'N_g3',color:'#f52800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#b32800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g1',color:'#a32800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g2',color:'#a52800', bc: '#0000FF', bw: '0' } }

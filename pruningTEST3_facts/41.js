...
stri =stri+'<tr><td>N_R</td><td>0.9899580648320795</td></tr>';
stri =stri+'<tr><td>N_l2_1</td><td>0.003144890904906143</td></tr>';
stri =stri+'<tr><td>N_l1_2</td><td>0.0022092134928937417</td></tr>';
stri =stri+'<tr><td>N_l1_1</td><td>0.002209213492893673</td></tr>';
stri =stri+'<tr><td>N_l1_3</td><td>0.0015724454524530715</td></tr>';
stri =stri+'<tr><td>N_g3</td><td>3.020572749242743E-4</td></tr>';
stri =stri+'<tr><td>N_g1</td><td>3.020572749242743E-4</td></tr>';
stri =stri+'<tr><td>N_g2</td><td>3.020572749242743E-4</td></tr>';
...
,{ data: { id: 'N_l1_1',color:'#0228f9', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_2',color:'#0228f9', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l1_3',color:'#0228f9', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_g3',color:'#0028ff', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_l2_1',color:'#0428f3', bc: '#0000FF', bw: '0' } }

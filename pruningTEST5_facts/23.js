...
stri =stri+'<tr><td>N_G</td><td>0.4193241313660162</td></tr>';
stri =stri+'<tr><td>N_L</td><td>0.23798191337458352</td></tr>';
stri =stri+'<tr><td>N_M</td><td>0.19038553069966682</td></tr>';
stri =stri+'<tr><td>N_N</td><td>0.15230842455973345</td></tr>';
...
,{ data: { id: 'N_M',color:'#f22800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_N',color:'#c22800', bc: '#0000FF', bw: '0' } }

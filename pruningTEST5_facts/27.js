...
stri =stri+'<tr><td>N_G</td><td>0.2096620656830081</td></tr>';
stri =stri+'<tr><td>N_L</td><td>0.11899095668729176</td></tr>';
stri =stri+'<tr><td>N_M</td><td>0.09519276534983341</td></tr>';
stri =stri+'<tr><td>N_N</td><td>0.07615421227986673</td></tr>';
...
,{ data: { id: 'N_L',color:'#972800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_M',color:'#792800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_N',color:'#612800', bc: '#0000FF', bw: '0' } }

...
stri =stri+'<tr><td>N_N</td><td>0.4193241313660162</td></tr>';
stri =stri+'<tr><td>N_L</td><td>0.19038553069966682</td></tr>';
stri =stri+'<tr><td>N_M</td><td>0.15230842455973345</td></tr>';
stri =stri+'<tr><td>N_R</td><td>0.11899095668729176</td></tr>';
stri =stri+'<tr><td>N_G</td><td>0.11899095668729176</td></tr>';
...
,{ data: { id: 'N_R',color:'#972800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_L',color:'#f22800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_M',color:'#c22800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_N',color:'#ff2800', bc: '#0000FF', bw: '0' } }
,{ data: { id: 'N_G',color:'#972800', bc: '#0000FF', bw: '0' } }
